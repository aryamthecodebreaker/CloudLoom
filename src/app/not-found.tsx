...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-loom-cloud px-6 text-center">
      <p className="text-7xl font-extrabold tracking-tight text-loom-blue">404</p>
      <h1 className="mt-4 text-xl font-bold text-loom-navy">
