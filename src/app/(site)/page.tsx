    ...
    <>
      ...
      <section className="relative overflow-hidden bg-loom-navy text-white">
        ...
        <div
          ...
          aria-hidden
        />
        <div className="container-loom relative flex flex-col items-center py-28 text-center md:py-36">
          <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest">
            <span className="h-1.5 w-1.5 rounded-full bg-loom-pink" />
          ...
          <h1 className="max-w-4xl text-4xl font-extrabold leading-tight tracking-tight md:text-6xl md:leading-[1.08]">
            ...
            <br />
            <span className="bg-gradient-to-r from-sky-300 via-loom-blue to-loom-pink bg-clip-text text-transparent">
              and everything you run.
            </span>
          </h1>
          <p className="mt-7 max-w-2xl text-lg leading-relaxed text-slate-300">
            CloudLoom connects your code, cloud, identities, and runtime into a single
      ...
      {/* Trust strip */}
      <section className="border-b border-loom-line bg-loom-cloud py-8">
        <div className="container-loom flex flex-wrap items-center justify-center gap-x-12 gap-y-4 text-sm font-bold tracking-wide text-slate-400">
          <span>TRUSTED IN DEMOS BY</span>
          {["Northwind Labs", "Acme Robotics", "Globex Cloud", "Initech Systems", "Hooli Ventures"].map((c) => (
            <span key={c} className="transition hover:text-loom-blue">{c}</span>
          ))}
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container-loom grid items-center gap-14 lg:grid-cols-2">
          <div>
            <span className="text-sm font-semibold uppercase tracking-widest text-loom-blue">The Security Graph</span>
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-loom-navy md:text-4xl">
              One graph. Every relationship. Zero guesswork.
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-slate-600">
              Most tools show you thousands of alerts. CloudLoom shows you the handful of
            ...
            <ul className="mt-8 space-y-4">
              {[
                ...
                <li key={t} className="flex gap-3">
                  <span className="mt-1 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-loom-blue/10 text-xs font-bold text-loom-blue">✓</span>
                  <p><strong className="font-semibold text-loom-navy">{t}.</strong> <span className="text-slate-600">{d}</span></p>
                </li>
              ))}
            </ul>
          </div>
      ...
      {/* Modules */}
      <section className="bg-loom-cloud py-24">
        <div className="container-loom">
          <div className="mx-auto max-w-2xl text-center">
            <span className="text-sm font-semibold uppercase tracking-widest text-loom-blue">Platform</span>
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-loom-navy md:text-4xl">
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-3">
            {modules.map((m) => (
              <article key={m.name} className="group rounded-2xl border border-loom-line bg-white p-8 shadow-card transition hover:-translate-y-1 hover:border-loom-blue/40">
                ...
                <h3 className="mt-5 text-xl font-bold text-loom-navy">{m.name}</h3>
                ...
                <ul className="mt-6 space-y-2 border-t border-loom-line pt-5">
                  {m.points.map((p) => (
      ...
      <section className="relative overflow-hidden bg-loom-navy py-24 text-white">
        <div className="grain absolute inset-0" aria-hidden />
        <div className="container-loom relative">
          <div className="mx-auto max-w-2xl text-center">
            <span className="text-sm font-semibold uppercase tracking-widest text-loom-pink">Agentic security</span>
      ...
      {/* Stats */}
      <section className="py-24">
        <div className="container-loom grid gap-8 text-center sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={n}>
              <p className="bg-gradient-to-r from-loom-blue to-loom-pink bg-clip-text text-4xl font-extrabold text-transparent">{n}</p>
      ...
      <section className="pb-24">
        <div className="container-loom">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-loom-blue to-loom-navy px-8 py-16 text-center text-white shadow-graph">
            <div className="grain absolute inset-0" aria-hidden />
            ...
            <div className="relative mt-8 flex flex-wrap justify-center gap-4">
              <Link href="/console" className="rounded-lg bg-white px-7 py-3 text-base font-semibold text-loom-blue transition hover:bg-sky-100">
                Open the console
              </Link>
...
function GraphMock() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-loom-line bg-gradient-to-br from-loom-navy via-[#12245c] to-loom-blue p-6 shadow-graph">
      <div className="grain absolute inset-0" aria-hidden />
